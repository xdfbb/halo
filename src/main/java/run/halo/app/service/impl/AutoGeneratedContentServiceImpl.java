...
public class AutoGeneratedContentServiceImpl implements AutoGeneratedContentService {
    ...
    public Page<WechatAccDTO> findAllWechatAccByRank(
        ...
        Page<WechatAcc> wechatAccPage = wechatAccRepository.findAll(pageable);
        // Convert and return
    ...
    public Page<WeixinAppletDTO> findAllWeixinAppletByRank(
        Pageable pageable) {
        Page<WeixinApplet> wechatAppletPage = wechatAppletRepository.findAll(pageable);
        // Convert and return
        return wechatAppletPage.map(wechatApplet -> new WeixinAppletDTO().convertFrom(wechatApplet));
    }

    @Override
    public Page<ZhiHuDTO> findAllZhiHuByLike(
        Pageable pageable) {
        Page<ZhiHu> zhiHuAccPage = zhihuRepository.findAll(pageable);
        // Convert and return
    ...
    public Page<DouYinDTO> findAllDouYinByLike_count(
        Pageable pageable) {
        Page<DouYin> douyinAccPage = douYinRepository.findAll(pageable);
        // Convert and return
